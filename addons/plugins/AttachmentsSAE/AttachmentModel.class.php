...
class AttachmentModel extends ETModel {
	...
	{
		@unlink(PATH_SAESTOR.$this->path().$attachment["attachmentId"].'_'.$attachment["filename"]);
		@unlink(PATH_SAESTOR.$this->path().$attachment["attachmentId"]."_thumb_".$attachment["filename"]);
	}
