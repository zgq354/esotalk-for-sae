...
ET::$pluginInfo["AttachmentsSAE"] = array(
	"name" => "AttachmentsSAE",
	"description" => "Allows users to attach files to their posts.",
	"version" => ESOTALK_VERSION,
	"author" => "zgq354(Origined by Toby Zerner)",
...
class ETPlugin_AttachmentsSAE extends ETPlugin {
	...
	public function setup($oldVersion = "")
	{
		...
		//file_put_contents(PATH_SAESTOR.PATH_UPLOADS."/attachments/index.html", "");
	...
	public function init()
	{
		...
		function formatAttachment($attachment, $expanded = false)
		{
			...
			if (in_array($extension, array("jpg", "jpeg", "png", "gif"))) {
				...
				else return "<a href='".$url."' class='' target='_blank'><img src='".URL("attachment/thumb/".$attachment["attachmentId"])."' alt='".$filename."' title='".$filename."'></a>";
			}
